  ...
  <div>
    ...
    <el-dialog title="识别结果" :visible.sync="dialogTableVisible">
      <el-table :data="responseData">
        ...
        <el-table-column property="year" show-overflow-tooltip label="年份" width="150"></el-table-column>
...
export default {
  data() {
    return {
      ...
      dataimg: [
        {
          id: 1,
          idView: require("../../assets/picture/car/途观1.jpg"),
          txt2: "途观"
        },
        {
          id: 2,
          idView: require("../../assets/picture/car/丰田1.jpg"),
          txt2: "丰田"
        },
        {
          id: 3,
          idView: require("../../assets/picture/car/本田1.jpg"),
          txt2: "本田"
        },
        {
          id: 4,
          idView: require("../../assets/picture/car/迈凯伦1.jpg"),
          txt2: "迈凯伦"
        },
        {
          id: 5,
          idView: require("../../assets/picture/car/宝马1.jpg"),
          txt2: "宝马"
        },
      ]
    };
  ...
  methods: {
    ...
    uploadimg(fileObject) {
      ...
      axios
        .post("http://localhost:8081/thingsIdentify/carDetect", form)
        .then(res => {
