...
<el-dialog title="识别结果" :visible.sync="dialogTableVisible">
  <el-table :data="responseData">
    <el-table-column property="baikeInfo.description" show-overflow-tooltip label="百度信息" width="450"></el-table-column>
    <el-table-column property="name" show-overflow-tooltip label="名称" width="300"></el-table-column>
